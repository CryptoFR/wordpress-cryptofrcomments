	  ...
	  <div class="modal-content">
	    <div class="modal-body clearfix">
	      ...
	      <div class="modal-login-alternative">  
	        <ul class="alt-logins">
	          <li class="google">
	            <a rel="nofollow noopener noreferrer alt-login" target="_top" data-link="<?php echo constant("NODEBB_URL"); ?>/auth/google" href="#" data-network="Google">
	          ...
	          <li class="facebook">
	            <a rel="nofollow noopener noreferrer alt-login" target="_top" data-link="<?php echo constant("NODEBB_URL"); ?>/auth/facebook" href="#" data-network="Facebook">
	          ...
	          <li class="twitter">
	            <a rel="nofollow noopener noreferrer alt-login" target="_top" data-link="<?php echo constant("NODEBB_URL"); ?>/auth/twitter" href="#" data-network="Twitter">
	          ...
	          <li class="github">
	            <a rel="nofollow noopener noreferrer alt-login" target="_top" data-link="<?php echo constant("NODEBB_URL"); ?>/auth/github" href="#" data-network="Github">
